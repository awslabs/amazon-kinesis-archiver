...
module.exports = function(setRegion, kinesisClient, dynamoDB) {
     ...
     * console
     */
    queryToStdConsole = function(streamName, sequenceStart, lastUpdateDateStart, approximateArrivalStart, recordLimit,
	    callback) {
	// create default console
	const
	c = require('console');
	// wrap customer console scan
	queryToCustomConsole(streamName, partitionKey, sequenceStart, sequenceEnd, recordLimit, 1, callback);
    }
